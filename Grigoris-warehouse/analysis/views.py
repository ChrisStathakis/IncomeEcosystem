...
class BalanceSheetView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        tax_incomes = ((incomes_total * (float(taxes_6)/100)) * 0.06) + ((incomes_total * (float(taxes_13)/100)) * 0.13) + ((incomes_total * (float(taxes_24)/100)) * 0.24)
        tax_orders = ((payments_total * (float(taxes_6)/100)) * 0.06) + ((payments_total * (float(taxes_13)/100)) * 0.13) + ((payments_total * (float(taxes_24)/100)) * 0.24)
        tax_orders = tax_orders + (float(general_total)*0.24)
        print('fpa', incomes_total,tax_incomes)
        context.update(locals())
        return context
